...
// precondition or postcondition (respsectively).
...
// e.g.  void CloneString( _In_z_ const WCHAR* wzFrom, _Deref_out_z_ WCHAR**
// pWzTo );
...
// e.g. void SaveStringArray( _In_count_(cStrings) _Deref_pre_z_ const WCHAR*
// const rgpwch[] );
...
// _Deref_post_z_ WCHAR* const rgpwch[] ); buffer capacity is described by
// another parameter
...
#define _Post_maybez_                                                          \
  _SAL1_1_Source_(_Post_maybez_, (), _Post1_impl_(__maybezterm_impl))
...
#define _Raises_SEH_exception_                                                 \
  _Group_(_Maybe_raises_SEH_exception_ _Analysis_noreturn_)
