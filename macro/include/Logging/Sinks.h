...
protected:
    ...
    {
        SDL_ShowSimpleMessageBox(SDL_MESSAGEBOX_ERROR, "Error", msg.payload.data(), nullptr);
        SDL_Event e;
...
using macro_exception_sink_st = macro_exception_sink<spdlog::details::null_mutex>;